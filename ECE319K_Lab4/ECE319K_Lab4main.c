...
int main2(void){ // main2
  ...
  UART_Init();
  UART_OutString("Lab 4, Fall 2025, Step 1. Debug LEDs\n\r");
...
int main3(void){ // main3
  ...
  UART_OutString("Lab 4, Fall 2025, Step 2. Debug switches\n\r");
  UART_OutString("EID1= "); UART_OutString((char*)EID1); UART_OutString("\n\r");
  UART_OutString("EID2= "); UART_OutString((char*)EID2); UART_OutString("\n\r");
  while(1){
...
uint32_t input;
 ...
 // set initial state
  ...
  UART_Init();
  __enable_irq(); // UART uses interrupts
  UART_OutString("Lab 4, Fall 2025, Step 3. Debug FSM cycle\n\r");
  UART_OutString("EID1= "); UART_OutString((char*)EID1); UART_OutString("\n\r");
  UART_OutString("EID2= "); UART_OutString((char*)EID2); UART_OutString("\n\r");
// initialize your FSM
